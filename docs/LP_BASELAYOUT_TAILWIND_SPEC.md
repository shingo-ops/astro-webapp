...
### 4-1. カラーパレット（Meta Blue 系統 — 2026-04-29 しんごさん要望反映）

「Meta Business Suite 寄り Salesforce 的」コンセプト。`#1877F2` を `brand-500` に置く Meta 公式 Blue 系統。

| トークン | 値 | 用途 |
|---|---|---|
| `brand-50` | `#e7f3ff` | hero 背景・薄い帯 |
| `brand-100` | `#d0e8ff` | hover 状態・カード背景 |
| `brand-200` | `#a8d2ff` | border・区切り |
| `brand-300` | `#6bb6ff` | hover border |
| `brand-400` | `#2e94ff` | アクセント |
| `brand-500` | `#1877f2` | **primary（Meta Blue）** |
| `brand-600` | `#166fe5` | primary ボタン hover（Meta 公式 hover）|
| `brand-700` | `#1463cc` | active / pressed |
| `brand-800` | `#1158b5` | より深い hover |
| `brand-900` | `#0e498f` | 見出し |
...
### 4-5. tailwind.config.mjs（PR #185 で投入済）

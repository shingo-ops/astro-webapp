...
import type { Conversation, PlatformFilter } from "../../lib/messages";
import { getInitials, relativeTime, STATUS_TABS } from "./inbox.types";
import type { StatusTabKey } from "./inbox.types";

interface Props {
  // フィルタ
  statusTab: StatusTabKey;
  setStatusTab: (tab: StatusTabKey) => void;
...
export function InboxConversationList({
  statusTab, setStatusTab, platformFilter, setPlatformFilter,

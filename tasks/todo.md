...
| QAチェックシート I-03 再分類 + リンク監査 | Agent | feature/morimoto/qa-checksheet-i03-regroup で I-03(AND/OR切替・見積画面)を「A.在庫メインページ」→「F.在庫検索(見積)」へ移動。全12 URL を App.tsx ルートと照合し古いリンク0件・base URL=app.salesanchor.jp 現行を確認 | docs-only。CI green 後 merge | docs/audit/qa_checksheet.html | 2026-05-30 |

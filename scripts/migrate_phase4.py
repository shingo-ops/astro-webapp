...
async def main():
    ...
    try:
        logger.info("=== Phase 4 マイグレーション開始 ===")
        sql = (BASE_DIR / "migrations" / "008_add_phase4_permissions.sql").read_text("utf-8")
        ...
        tmpl = (BASE_DIR / "migrations" / "009_add_phase4_tenant_tables.sql").read_text("utf-8")
        ...
        logger.info("=== Phase 4 マイグレーション完了 ===")
    finally:
